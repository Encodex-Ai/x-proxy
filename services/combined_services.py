...
class CombinedServices:
    def __init__(self, mongodb_service, x_service):
    ...
    def post_draft_tweet(self, draft_tweet_record_id):
        ...
        draft_tweet = self.mongodb_service.get_record(
            table_id=self.mongodb_service.candidate_tweets_collection,
        ...
        tweet_content = draft_tweet["fields"].get("content_cleaned") or draft_tweet[
            "fields"
        ].get("content")
